...
#define ANSI_CREATE_ATTR(attr) CSI attr "m"
#define ANSI_CREATE_ATTRS(attr, ...) CSI JOIN(L";", attr, ## __VA_ARGS__) L"m"

#define ANSI_SET_CL_MD(foreground, background, markdown, ...)  ANSI_CREATE_ATTRS(foreground, background, markdown) JOIN(ANSI_CREATE_ATTRS(foreground, background, markdown), __VA_ARGS__) ANSI_CREATE_ATTRS(ANSI_FG_DEFAULT, ANSI_BG_DEFAULT, __ANSI_ATTR_DISABLE_MARKDOWN(markdown))
#define ANSI_SET_CL(foreground, background, ...)               ANSI_CREATE_ATTRS(foreground, background)           JOIN(ANSI_CREATE_ATTRS(foreground, background), __VA_ARGS__)           ANSI_CREATE_ATTRS(ANSI_FG_DEFAULT, ANSI_BG_DEFAULT)
